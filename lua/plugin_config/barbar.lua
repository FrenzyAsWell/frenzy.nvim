...
map('n', 'z3', '<Cmd>BufferGoto 3<CR>', opts)
map('n', 'z4', '<Cmd>BufferGoto 4<CR>', opts)
map('n', 'z5', '<Cmd>BufferGoto 5<CR>', opts)
map('n', 'z6', '<Cmd>BufferGoto 6<CR>', opts)
map('n', 'z7', '<Cmd>BufferGoto 7<CR>', opts)
map('n', 'z8', '<Cmd>BufferGoto 8<CR>', opts)
map('n', 'z9', '<Cmd>BufferGoto 9<CR>', opts)
map('n', 'z0', '<Cmd>BufferLast<CR>', opts)
-- Pin/unpin buffer
map('n', 'zp', '<Cmd>BufferPin<CR>', opts)
-- Close buffer
map('n', 'zc', '<Cmd>BufferClose<CR>', opts)
-- Wipeout buffer
--                 :BufferWipeout
-- Close commands
